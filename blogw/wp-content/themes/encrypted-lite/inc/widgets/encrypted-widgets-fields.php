...
function encrypted_lite_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    $encrypted_lite_postlist[0] = array(
        'value' => 0,
        'label' => __('--choose--', 'encrypted-lite')
    );
    ...
    switch ($encrypted_lite_widgets_field_type) {
        ...
        case 'text' :
            ?>
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>"><?php echo esc_html($encrypted_lite_widgets_title); ?>:</label>
                <input class="widefat" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" type="text" value="<?php echo esc_attr($athm_field_value); ?>" />

                <?php if (isset($encrypted_lite_widgets_description)) { ?>
                    <br />
                    <small><?php echo esc_html($encrypted_lite_widgets_description); ?></small>
                <?php } ?>
            </p>
            <?php
            break;
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>"><?php echo esc_html($encrypted_lite_widgets_title); ?>:</label>
                <textarea class="widefat" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>"><?php echo esc_html($athm_field_value); ?></textarea>
            </p>
            <?php
            break;
        ...
        case 'checkbox' :
            ?>
            <p>
                <input id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>"><?php echo esc_html($encrypted_lite_widgets_title); ?></label>
        ...
        case 'radio' :
            ...
            <p>
                ...
                foreach ($encrypted_lite_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo esc_attr($instance->get_field_id($athm_option_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" type="radio" value="<?php echo esc_attr($athm_option_name); ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        case 'select' :
            ...
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>"><?php echo esc_html($encrypted_lite_widgets_title); ?>:</label>
                <select name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" class="widefat">
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>"><?php echo esc_html($encrypted_lite_widgets_title); ?>:</label><br />
                <input name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" type="number" step="1" min="1" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" value="<?php echo esc_attr($athm_field_value); ?>" class="small-text" />
            ...
            <p>
                ...
                <select name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" class="widefat">
                    <?php foreach ($encrypted_lite_postlist as $encrypted_lite_single_post) { ?>
                        <option value="<?php echo esc_attr($encrypted_lite_single_post['value']); ?>" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_single_post['label'])); ?>" <?php selected($encrypted_lite_single_post['value'], $athm_field_value); ?>><?php echo esc_html($encrypted_lite_single_post['label']); ?></option>
                    <?php } ?>
                </select>
        ...
        case 'upload' :
            ...
            $output .= '<label for="'.esc_attr($instance->get_field_id($encrypted_lite_widgets_name)).'">'.esc_html($encrypted_lite_widgets_title).'</label><br/>';
            $output .= '<input id="' . esc_attr($id) . '" class="upload' . esc_attr($class) . '" type="text" name="' . esc_attr($name) . '" value="' . esc_attr($value) . '" placeholder="' . __('No file chosen', 'encrypted-lite') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                if (( $value == '')) {
                    $output .= '<input id="upload-' . esc_attr($id) . '" class="upload-button-widget button" type="button" value="' . __('Upload', 'encrypted-lite') . '" />' . "\n";
                } else {
                    $output .= '<input id="remove-' . esc_attr($id) . '" class="remove-file-widget button" type="button" value="' . __('Remove', 'encrypted-lite') . '" />' . "\n";
                }
            } else {
        ...
        case 'icon' :
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo esc_attr($instance->get_field_name($encrypted_lite_widgets_name)); ?>" type="hidden" id="<?php echo esc_attr($instance->get_field_id($encrypted_lite_widgets_name)); ?>" value="<?php echo esc_attr($athm_field_value); ?>" />
 ...
 */
function encrypted_lite_widget_media_scriptss($hook) {

    if (function_exists('wp_enqueue_media'))
        wp_enqueue_media();

    wp_register_script('encrypted-lite-media-uploader', get_template_directory_uri() . '/inc/path/js/media-uploader.js', array('jquery'), 1.70);
    wp_enqueue_script('encrypted-lite-media-uploader');
    wp_localize_script('encrypted-lite-media-uploader', 'encrypted_widget_l10n', array(
        'upload' => __('Upload', 'encrypted-lite'),
        'remove' => __('Remove', 'encrypted-lite')
    ));
}

add_action('admin_enqueue_scripts', 'encrypted_lite_widget_media_scriptss');
